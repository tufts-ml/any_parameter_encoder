...
if __name__ == "__main__":
    ...
    training_set = ToyBarsDataset(training=True, doc_file='data/train_topics.npy', num_models=50000, **data_config)
    validation_set = ToyBarsDataset(training=False, doc_file='data/valid_topics.npy', num_models=500, **data_config)
